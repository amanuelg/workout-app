...
RSpec.feature "Creating Exercise" do
    before do
        @jhon = User.create!(first_name: "jhon", last_name: "Doe",email: "jhon@example.com", password: "password")
        login_as(@jhon)
    end
    ...
    scenario "with valid inputs" do
        ...
        fill_in "Activity date", with: "2016-01-10"
